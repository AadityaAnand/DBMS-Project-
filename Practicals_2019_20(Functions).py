...
import pandas as p
mysql1=mysql.connector.connect(host='localhost', user='root', password='mysql', database='Practicals_2019_20')
mysqlex=mysql.connector.connect(host='localhost', user='root', password='mysql', database='Practicals_2019_20')
